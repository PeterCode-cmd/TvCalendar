...
/*val sortOptions = listOf("Najnowsze", "Ilość głosów", "Popularność", "Ocena")
        ...
        applyButton.setOnClickListener {
            ...
            onFilterSelectedListener.onFilterApplied(selectedYear, selectedVote, selectedProviders, selectedGenres, currentPage)
            dismiss()
        }
    ...
    interface OnFilterSelectedListener {
        fun onFilterApplied(year: String, voteAmount: String, selectedProviders: List<String>, selectedGenres: List<String>, currentPage: Int)
    }
}
*/
